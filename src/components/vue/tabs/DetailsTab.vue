    ...
    <div class="list-group list-group-flush">
      <div class="list-group-item">
        ...
        <div class="d-flex gap-3 mb-3 my-3">
          <img :src="club1?.logo_url" alt="" width="64" height="64" style="object-fit: contain" />
        ...
        <!-- header away -->
        <div class="d-flex gap-3 mb-3 my-3">
          <img :src="club2?.logo_url" alt="" width="64" height="64" style="object-fit: contain" />
          <div class="d-flex flex-column justify-content-center">
      ...
      <div class="list-group-item">
        <div class="d-flex justify-content-between my-3">
          <div class="d-flex flex-column justify-content-center">
            <img :src="club1?.logo_url" alt="" width="32" height="32" style="object-fit: contain" />
          </div>
          ...
          <div class="d-flex flex-column justify-content-center">
            <img :src="club2?.logo_url" alt="" width="32" height="32" style="object-fit: contain" />
          </div>
        </div>
